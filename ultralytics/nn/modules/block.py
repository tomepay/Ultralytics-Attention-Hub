...
class C3k2CA(C3k2):
    ...
    def __init__(
        ...
        super().__init__(
            c1=c1, c2=c2, n=n, c3k=c3k, e=e, attn=attn, g=g, shortcut=shortcut
        )

        # === 关键优化：确保 hidden channels 总是 8 的倍数 ===
        hidden = make_divisible(int(c2 * e), 8)   # ← 只加这一行
